...
4. Authenticate and join the project oai-rfsim-training. Also make sure that you have uploaded your public ssh key.
```
slices auth login
slices project use oai-rfsim-training
slices pubkey register <public key>
``` 
